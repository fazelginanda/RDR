...
if __name__ == "__main__":
    ...
    # Menggunakan RDR yang sudah disimpan
        ...
        treeFilePath = input(
            "Masukkan path dari file tree yang akan digunakan: ")
        ...
        while inputNewData == '1':
            ...
            if feedback == '2':
                ...
                if difference:
                    ...
                    while True:
                        newCondition = input(
                            "Masukkan kondisi untuk rule baru: ")
                        newCondition = [condition.strip()
