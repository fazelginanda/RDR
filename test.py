...
def testInference():
    ...
    print("Kesimpulan: " + str(tree.deriveConclusion(data1, "")))

    data2 = ['A', 'B', 'D']
    print()
    print("Data: " + str(data2))
    print("Kesimpulan: " + str(tree.deriveConclusion(data2, "")))

    data3 = ['A', 'B', 'E']
    print()
    print("Data: " + str(data3))
    print("Kesimpulan: " + str(tree.deriveConclusion(data3, "")))

    data4 = ['C', 'F']
    print()
    print("Data: " + str(data4))
    print("Kesimpulan: " + str(tree.deriveConclusion(data4, "")))

    data5 = ['A', 'B', 'I']
    print()
    print("Data: " + str(data5))
    print("Kesimpulan: " + str(tree.deriveConclusion(data5, "")))
